...
module riscvsingle (input  logic        clk, reset,
   ...
   controller c (Instr[6:0], Instr[14:12], Instr[30], Zero, lt, ltu,
		 ...
		 ImmSrc, ALUControl, ALUSrcA, MemStrobe);
...
module controller (input  logic [6:0] op,
       ...
       output logic       ALUSrcA, MemStrobe);
   ...
   maindec md (op, ResultSrc, MemWrite, Branch,
	       ALUSrc, RegWrite, Jump, ImmSrc, ALUOp, ALUSrcA, MemStrobe);
   // Map to aludec
...
module maindec (input  logic [6:0] op,
   ...
   assign {RegWrite, ImmSrc, ALUSrc, MemWrite,
	   ResultSrc, Branch, ALUOp, Jump, ALUSrcA, MemStrobe} = controls;
